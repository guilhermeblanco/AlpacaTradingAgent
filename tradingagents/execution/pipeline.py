...
class ExecutionPipeline:
    ...
    def execute(
        ...
        *,
        ...
        self.journal.append("broker_submitted", symbol=parsed.symbol, decision_id=parsed.decision_id, run_id=run_id, payload={"gateway": self.gateway.name})
...
def execute_autonomous_trade(
    ...
    *,
    ...
    config = None
    if gateway is None or journal is None or risk_sizer is None:
        try:
